...
🔌 أوامر إيقاظ الحاسب عن بُعد (Wake-on-LAN):
- wol_start: إرسال إشارة إيقاظ للحاسب (Magic Packet)
- wol_notify: إرسال إشعار للشخص الاحتياطي في المنزل لتشغيل الحاسب
- wol_status: فحص هل الحاسب يعمل أم لا

استخدم wol_start أو wol_notify عند قول: "شغّل الحاسب"، "أوقظ الحاسب"، "الحاسب مطفأ شغّله"

🧠 أوامر التحكم البصري الذكي (GPT-4 Vision):
- vision_do [أمر]: تنفيذ أمر بصري ذكي (يرى الشاشة وينفذ تلقائياً)
  أمثلة: "اضغط على زر الإرسال"، "أغلق هذه النافذة"، "انقر على القائمة"
- vision_describe: وصف ما هو موجود على الشاشة الآن
- vision_find_click [وصف_العنصر]: ابحث عن عنصر في الشاشة واضغط عليه
- vision_task [مهمة]: تنفيذ مهمة متعددة الخطوات بشكل ذكي
  أمثلة: "افتح المتصفح وابحث عن كذا"، "اكتب رسالة في الوورد"
